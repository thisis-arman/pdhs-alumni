...
export default function Example() {
    return (
        <form className='max-w-screen-lg py-24 p-8 mx-auto'>
            <div className="space-y-12">
                        ...
                        <div className="sm:col-span-4">
                            ...
                            <div className="mt-2">
                                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    {/* <span className="flex select-none items-center pl-3 text-gray-500 sm:text-sm md:text-md">workcation.com/</span> */}
                                    <input
                                        id="username"
                                        name="username"
                                        type="text"
                                        ...
                                        className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-black placeholder:text-gray-400 focus:ring-0 sm:text-sm md:text-md sm:leading-6"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-span-full">
                            ...
                            <div className="mt-2">
                                <textarea
                                    ...
                                    name="about"
                                    rows={3}
                                    className="block w-full rounded-md border-0 bg-transparent py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm md:text-md sm:leading-6"
                                    defaultValue={''}
                                />
                            </div>
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    className="block w-full rounded-md bg-transparent border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm md:text-md sm:leading-6"
                                />
                            </div>
                        </div>
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                                <select
                                    ...
                                    className="block w-full rounded-md bg-transparent border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm md:text-md sm:leading-6"
                                >
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-black">Professional Information</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">Use a permanent address where you can receive mail.</p>
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    type="text"
                                    autoComplete="given-name"
                                    className="block w-full rounded-md bg-transparent border-none py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600  sm:text-sm md:text-md sm:leading-6"
                                />
                            </div>
                        </div>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-black">Educational Information</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">Use a permanent address where you can receive mail.</p>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-black">Notifications</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                                ...
                                <div className="relative flex gap-x-3">
                                    <div className="flex h-6 items-center">
                                        <input
                                            ...
                                            name="comments"
                                            type="checkbox"
                                            className="h-4 w-4 rounded border-gray-300 bg-transparent text-indigo-600 focus:ring-indigo-600"
                                        />
                                    </div>
